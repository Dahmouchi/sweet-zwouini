import PageHeader from "@/components/pageHeader";
  ...
  return (
    <>
      ...
      <div className="terms-conditions-area ptb-120 border-bottom">
        <div className="container">
          <div className="terms-conditions-content" data-cue="slideInUp">
            <h4>Overview</h4>
            <p>
            ...
            <p>
              This site is provided by <strong>Lanklub</strong>.{" "}
              <strong>Lanklub</strong> collects information in several ways from
            ...
            <p>
              <strong>Lanklub</strong> accepts the following payment methods:
            </p>
            <ul>
              <li>
              ...
              <li>
                <strong>Lanklub</strong> features a Fast Checkout option,
            ...
            <p>Last updated: January 25, 2025 at 24:00 pm</p>
          </div>
        </div>
      </div>
    </>
